...
public class MultiScaleGraphEditDistance {
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	public MultiScaleGraphEditDistance(Graph G1, Graph G2,ICostFunction costfunction, IEdgeHandler edgehandler,boolean debug){
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Graph H = louvain.findCommunities();
		//H = louvain.findCommunities();
...
//		}
	...
	private static void t4()
	{
		...
		try {
			...
			FileWriter fw = new FileWriter(GraphEditDistance.class.getName()+".csv", false);
