...
public class EditPathExtender {
	...
	public EditPathExtender(EditPath ED, EditPath UB, double UBCOST,ICostFunction costfunction, IEdgeHandler edgehandler,int heuristicmethod,int maxed,BufferedWriter BW,boolean debug){
		this.maxed = maxed;
		this.debug = debug;
		this.BW = BW;
	...
	public EditPath getUB() {
		return UB;
	}

	public void setUB(EditPath uB) {
		UB = uB;
	}

	private void init(EditPath ROOT) {
